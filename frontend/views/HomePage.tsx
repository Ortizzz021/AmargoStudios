    ...
    <>
      ...
      <section className="container">
        ...
        <div className="grid grid-2">
          <div className="media-container">
            <Image src="/images/jerless1.webp" alt="Proyecto audiovisual 3" width={700} height={500} loading="lazy" />
          </div>
          <div className="media-container">
            <Image src="/images/sprinterz.webp" alt="Proyecto audiovisual 2" width={700} height={500} loading="lazy" />
          </div>
          <div className="media-container">
            <Image src="/images/fabian1.webp" alt="Proyecto audiovisual 4" width={700} height={500} loading="lazy" />
          </div>
        </div>
      </section>
